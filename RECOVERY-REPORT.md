...
Generated 2026-09-26T16:22:46.840014+00:00 from committed recovery state. No CAPTCHA solving, proxy/identity rotation, fingerprint spoofing, or rate-limit circumvention is used anywhere in this pipeline: challenged endpoints are routed around through lawful public representations, or recorded as unresolved.

## 1. Challenge / non-content responses

- **6290** challenge/non-content observations across the corpus (latest observation per URL).
- Requested-URL coverage states: UNRESOLVED_CHALLENGE: 4005, NON_CONTENT_TECHNICAL_RESPONSE: 1130, RECOVERED_WEB_ARCHIVE: 716, RECOVERED_OFFICIAL_MIRROR: 319, ACCESS_RESTRICTED: 119, ARCHIVED_CONTENT: 1
...
| ncua.gov | NON_CONTENT_TECHNICAL_RESPONSE: 7 |
...
| www.federalregister.gov | RECOVERED_OFFICIAL_MIRROR: 319, UNRESOLVED_CHALLENGE: 135 |
...
| www.justice.gov | UNRESOLVED_CHALLENGE: 3651, RECOVERED_WEB_ARCHIVE: 716, ACCESS_RESTRICTED: 4, NON_CONTENT_TECHNICAL_RESPONSE: 3 |
...
- Document-identity coverage: UNRESOLVED_CHALLENGE: 4005, NON_CONTENT_TECHNICAL_RESPONSE: 1130, RECOVERED_WEB_ARCHIVE: 716, RECOVERED_OFFICIAL_MIRROR: 319, ACCESS_RESTRICTED: 119, ARCHIVED_CONTENT: 1

## 4–7. Recovery outcomes

- Same-agency recoveries (`SAME_DOCUMENT`): 1
- Official government mirrors (`OFFICIAL_MIRROR`): 319
- Public web archive (`ARCHIVED_VERSION`): 716
- Derived representations (API metadata records): 319
- Still unresolved: **5254** (by tier: {0: 159, 1: 1872, 2: 3223})
...
- DOJ URL states: UNRESOLVED_CHALLENGE: 3651, RECOVERED_WEB_ARCHIVE: 716, ACCESS_RESTRICTED: 4, NON_CONTENT_TECHNICAL_RESPONSE: 3

## 10. Federal Register

- FR URL states: RECOVERED_OFFICIAL_MIRROR: 319, UNRESOLVED_CHALLENGE: 135
...
- `ACCESS_INTERSTITIAL|redirect_to_interstitial_endpoint` × 454
...
- `BOT_CHALLENGE|detection_mode:metadata_only|expected_document_body_missing|host_challenge_pattern|small_html_success:2443` × 67
...
- `BOT_CHALLENGE|detection_mode:metadata_only|expected_document_body_missing|host_challenge_pattern|small_html_success:2487` × 50
