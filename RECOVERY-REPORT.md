...
Generated 2026-08-19T16:59:13.349727+00:00 from committed recovery state. No CAPTCHA solving, proxy/identity rotation, fingerprint spoofing, or rate-limit circumvention is used anywhere in this pipeline: challenged endpoints are routed around through lawful public representations, or recorded as unresolved.

## 1. Challenge / non-content responses

- **6277** challenge/non-content observations across the corpus (latest observation per URL).
- Requested-URL coverage states: UNRESOLVED_CHALLENGE: 4534, NON_CONTENT_TECHNICAL_RESPONSE: 1120, RECOVERED_OFFICIAL_MIRROR: 317, RECOVERED_WEB_ARCHIVE: 188, ACCESS_RESTRICTED: 118
...
| www.justice.gov | UNRESOLVED_CHALLENGE: 4179, RECOVERED_WEB_ARCHIVE: 188, ACCESS_RESTRICTED: 4, NON_CONTENT_TECHNICAL_RESPONSE: 3 |
...
- Document-identity coverage: UNRESOLVED_CHALLENGE: 4534, NON_CONTENT_TECHNICAL_RESPONSE: 1120, RECOVERED_OFFICIAL_MIRROR: 317, RECOVERED_WEB_ARCHIVE: 188, ACCESS_RESTRICTED: 118

## 4–7. Recovery outcomes

- Same-agency recoveries (`SAME_DOCUMENT`): 0
- Official government mirrors (`OFFICIAL_MIRROR`): 317
- Public web archive (`ARCHIVED_VERSION`): 188
- Derived representations (API metadata records): 317
- Still unresolved: **5772** (by tier: {0: 159, 1: 2398, 2: 3215})
...
- DOJ URL states: UNRESOLVED_CHALLENGE: 4179, RECOVERED_WEB_ARCHIVE: 188, ACCESS_RESTRICTED: 4, NON_CONTENT_TECHNICAL_RESPONSE: 3
