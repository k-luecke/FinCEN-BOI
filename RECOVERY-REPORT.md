...
Generated 2026-09-18T16:19:34.625031+00:00 from committed recovery state. No CAPTCHA solving, proxy/identity rotation, fingerprint spoofing, or rate-limit circumvention is used anywhere in this pipeline: challenged endpoints are routed around through lawful public representations, or recorded as unresolved.

## 1. Challenge / non-content responses

- **6283** challenge/non-content observations across the corpus (latest observation per URL).
- Requested-URL coverage states: UNRESOLVED_CHALLENGE: 4381, NON_CONTENT_TECHNICAL_RESPONSE: 1125, RECOVERED_WEB_ARCHIVE: 340, RECOVERED_OFFICIAL_MIRROR: 317, ACCESS_RESTRICTED: 119, ARCHIVED_CONTENT: 1
...
| www.justice.gov | UNRESOLVED_CHALLENGE: 4027, RECOVERED_WEB_ARCHIVE: 340, ACCESS_RESTRICTED: 4, NON_CONTENT_TECHNICAL_RESPONSE: 3 |
...
- Document-identity coverage: UNRESOLVED_CHALLENGE: 4381, NON_CONTENT_TECHNICAL_RESPONSE: 1125, RECOVERED_WEB_ARCHIVE: 340, RECOVERED_OFFICIAL_MIRROR: 317, ACCESS_RESTRICTED: 119, ARCHIVED_CONTENT: 1

## 4–7. Recovery outcomes

- Same-agency recoveries (`SAME_DOCUMENT`): 1
- Official government mirrors (`OFFICIAL_MIRROR`): 317
- Public web archive (`ARCHIVED_VERSION`): 340
- Derived representations (API metadata records): 317
- Still unresolved: **5625** (by tier: {0: 159, 1: 2248, 2: 3218})
...
- DOJ URL states: UNRESOLVED_CHALLENGE: 4027, RECOVERED_WEB_ARCHIVE: 340, ACCESS_RESTRICTED: 4, NON_CONTENT_TECHNICAL_RESPONSE: 3
