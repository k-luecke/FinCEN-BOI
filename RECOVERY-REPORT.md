...
Generated 2026-09-25T17:15:05.754617+00:00 from committed recovery state. No CAPTCHA solving, proxy/identity rotation, fingerprint spoofing, or rate-limit circumvention is used anywhere in this pipeline: challenged endpoints are routed around through lawful public representations, or recorded as unresolved.

## 1. Challenge / non-content responses

- **6290** challenge/non-content observations across the corpus (latest observation per URL).
- Requested-URL coverage states: UNRESOLVED_CHALLENGE: 4058, NON_CONTENT_TECHNICAL_RESPONSE: 1130, RECOVERED_WEB_ARCHIVE: 663, RECOVERED_OFFICIAL_MIRROR: 319, ACCESS_RESTRICTED: 119, ARCHIVED_CONTENT: 1
...
| www.justice.gov | UNRESOLVED_CHALLENGE: 3704, RECOVERED_WEB_ARCHIVE: 663, ACCESS_RESTRICTED: 4, NON_CONTENT_TECHNICAL_RESPONSE: 3 |
...
- Document-identity coverage: UNRESOLVED_CHALLENGE: 4058, NON_CONTENT_TECHNICAL_RESPONSE: 1130, RECOVERED_WEB_ARCHIVE: 663, RECOVERED_OFFICIAL_MIRROR: 319, ACCESS_RESTRICTED: 119, ARCHIVED_CONTENT: 1

## 4–7. Recovery outcomes

- Same-agency recoveries (`SAME_DOCUMENT`): 1
- Official government mirrors (`OFFICIAL_MIRROR`): 319
- Public web archive (`ARCHIVED_VERSION`): 663
- Derived representations (API metadata records): 319
- Still unresolved: **5307** (by tier: {0: 159, 1: 1925, 2: 3223})
...
- DOJ URL states: UNRESOLVED_CHALLENGE: 3704, RECOVERED_WEB_ARCHIVE: 663, ACCESS_RESTRICTED: 4, NON_CONTENT_TECHNICAL_RESPONSE: 3
