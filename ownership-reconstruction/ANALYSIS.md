...
Temporal coverage: 752/948 edges carry a document date (1996-03-13 … 2026-07-28); 324 additionally carry a sentence-stated event date in `valid_from`.
...
| Bazzi | 5 | 5 | 1 | 1 | 3.5 | 5 |
| WFB | 3 | 3 | 1 | 1 | 2.7 | 3 |
| Wells Fargo Bank | 3 | 3 | 1 | 1 | 2.7 | 3 |
| Atlas Holding | 3 | 3 | 1 | 1 | 2.7 | 3 |
| SVB Leerink | 3 | 6 | 2 | 1 | 2.43 | 3 |
...
## 2b. Relationship persistence (84 relationships with multi-document evidence)
...
## 2c. Alias review queue (19 merge candidates touching active controllers)
...
| wfb ~ wells fargo bank | acronym-initials | 2.7 |
...
| cmc ~ chase manhattan corp | acronym-initials | 0.9 |
| washington mutual bank ~ washington mutual inc | cross-family-suffix | 0.9 |
| subchapter s corp ~ subchapter s corp unless the holding co | prefix-containment | 0.9 |
| bfc ~ bankmont financial corp | acronym-initials | 0.81 |
